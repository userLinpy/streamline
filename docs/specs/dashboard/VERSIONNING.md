...
| 0.6.0 | 2026-06-22 | Lin | Refonte UI icônes : remplacement de tous les emojis (★ ⚡ 📦 🔶 ✍ 📡 🔖 ⭐) par des icônes SVG vectorielles lucide-react/simple-icons. Nouveau composant SourceIcon (mapping source → icône SVG). ThemeToggle réécrit avec framer-motion : composant SolarSwitch animé (morphing soleil↔lune, pathLength, durée 0.7s). Dépendance framer-motion ^12.40.0 ajoutée. |
