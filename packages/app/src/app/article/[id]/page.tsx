...
import { ArrowLeft, ExternalLink, Clock, Zap, Star } from 'lucide-react'
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 pb-8">
      ...
      <article className="max-w-2xl mx-auto bg-white dark:bg-zinc-900 mt-4 mx-3 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm">
        ...
        <div className="p-6 border-b border-zinc-100 dark:border-zinc-800">
          <span className="inline-flex items-center gap-1 text-[10px] font-bold px-2 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800 mb-4">
            <SourceIcon source="devto" size={10} />
            Dev.to
          </span>
